  ...
  group('Check AsyncValue Easy when', () {
    ...
    testWidgets(
      ...
      (tester) async {
        await tester.pumpApp(
          ProviderScope(
            overrides: [testAsyncValuePod.overrideWith((ref) => throw "custom error")],
            child: Scaffold(
              body: Consumer(
                builder: (context, ref, child) {
                  final valueAsync = ref.watch(testAsyncValuePod);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(find.byType(DefaultDioErrorWidget), findsOneWidget);
        expect(
            find.text('Unable to connect to the server.Please try again later.'), findsOneWidget);
      },
    );
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpAndSettle();
        expect(find.byType(DefaultDioErrorWidget), findsOneWidget);
        expect(find.text('Check you internet connection reliability.'), findsOneWidget);
      },
    );
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpAndSettle();
        expect(find.byType(DefaultDioErrorWidget), findsOneWidget);
        expect(find.text('Please update your OS or add certificate.'), findsOneWidget);
      },
    );
    testWidgets(
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpAndSettle();
        expect(find.byType(DefaultDioErrorWidget), findsOneWidget);
        expect(find.text('Unable to connect to server.Please try again later.'), findsOneWidget);
      },
    );
    testWidgets(
