import 'package:edtech_app/shared/riverpod_ext/cache_extensions.dart';
          ...
          Consumer(
            builder: (context, ref, child) {
              return ElevatedButton(
                onPressed: () {
                  ref.read(cacheStateProvider.notifier).update((state) => state + 1);
                },
                child: child,
              );
            },
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              return ElevatedButton(
                onPressed: () {
                  ref.read(autoRefreshProvider.notifier).update((state) => state + 1);
                },
                child: child,
              );
            },
