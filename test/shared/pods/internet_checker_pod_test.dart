    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          container.read(internetConnectionCheckerInstancePod).onStatusChange.listen((event) {});
          final newStatus = await container.read(internetCheckerNotifierPod.future);

          expect(newStatus, InternetStatus.connected);
          expect(container.read(internetConnectionCheckerInstancePod).checkInterval,
