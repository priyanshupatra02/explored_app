...
import 'package:edtech_app/shared/pods/locale_pod.dart';
  ...
  group(
    ...
    () {
      ...
      testNotifier(
        ...
        emitBuildStates: true,
        act: (notifier) async =>
            await notifier.changeLocale(locale: const Locale.fromSubtags(languageCode: 'es')),
        expect: () => [
          const Locale.fromSubtags(languageCode: 'en'),
      ...
      testNotifier(
        ...
        emitBuildStates: true,
        act: (notifier) async =>
            await notifier.changeLocale(locale: const Locale.fromSubtags(languageCode: 'ar')),
        errors: () => [
