...
void main() {
  ...
  group('App Locale Popup Test', () {
    ...
    testWidgets('renders Applocalepopup within default English should be selected ',
        (tester) async {
    ...
    testWidgets('renders Applocalepopup within Spanish if selected Spanish ', (tester) async {
      await tester.pumpApp(
        ProviderScope(
          overrides: [
            enableInternetCheckerPod.overrideWith(
